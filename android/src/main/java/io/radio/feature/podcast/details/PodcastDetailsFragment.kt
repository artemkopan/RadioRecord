package io.radio.feature.podcast.details
...
import io.radio.R
import io.radio.feature.podcast.details.track.TracksAdapter
...
class PodcastDetailsFragment : BaseFragment(R.layout.fragment_podcast_details) {
    ...
    private val viewModel by viewModel<PodcastDetailsViewModelOld>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.openPlayerEventFlow.subscribe { it.consume { routePlayer() } }
